...
#define QML_LOG_INFO(message, ...) CLogger::instance(E_LOGGER_FLAG::QML)->log(E_LOGGER_LEVEL::INFO, __FILENAME__, __FUNCTION__, __LINE__, message, ##__VA_ARGS__);

#define QML_LOG_WARN(message, ...) CLogger::instance(E_LOGGER_FLAG::QML)->log(E_LOGGER_LEVEL::WARN, __FILENAME__, __FUNCTION__, __LINE__, message, ##__VA_ARGS__);

#define QML_LOG_FATAL(message, ...) CLogger::instance(E_LOGGER_FLAG::QML)->log(E_LOGGER_LEVEL::FATAL, __FILENAME__, __FUNCTION__, __LINE__, message, ##__VA_ARGS__);

#define QML_LOG_DEBUG(message, ...) CLogger::instance(E_LOGGER_FLAG::QML)->log(E_LOGGER_LEVEL::DEBUG, __FILENAME__, __FUNCTION__, __LINE__, message, ##__VA_ARGS__);
