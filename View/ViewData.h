...
DECLARE_POPUP_INFO(POPUP_Y, E_DURATION::IN_10_SECS)
DECLARE_POPUP_INFO(POPUP_Z, E_DURATION::NONE)

// [toast]
DECLARE_TOAST_INFO(TOAST_SUCCESS, E_DURATION::IN_5_SECS)
DECLARE_TOAST_INFO(TOAST_FAIL, E_DURATION::IN_5_SECS)

// [notify]
DECLARE_NOTIFY_INFO(NOTIFY_INFO, E_DURATION::NONE)
DECLARE_NOTIFY_INFO(NOTIFY_WARN, E_DURATION::NONE)
DECLARE_NOTIFY_INFO(NOTIFY_ERROR, E_DURATION::NONE)


static const S_VIEW_INFORMATION ALL_INFOR[13] = {
...
static const S_VIEW_EVENT  ALL_EVENTS[27] = {
    // [screen A]
