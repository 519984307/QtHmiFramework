...
static const S_VIEW_EVENT  ALL_EVENTS[30] = {
    // [screen A]
    {E_SCREEN_ID::E_SCREEN_A_ID, CViewEnums::E_SCREEN_A_EVT_SHOW, &SCREEN_A_ENTRY, E_SCREEN_ID::E_SCREEN_A_ID},
    {E_SCREEN_ID::E_SCREEN_A_ID, CViewEnums::E_SCREEN_A_EVT_BACK, &SCREEN_A_EXIT, E_SCREEN_ID::E_SCREEN_ANY_ID},
    ...
    {E_SCREEN_ID::E_SCREEN_B_ID, CViewEnums::E_SCREEN_B_EVT_BACK, &SCREEN_B_EXIT, E_SCREEN_ID::E_SCREEN_ANY_ID},
    ...
    {E_SCREEN_ID::E_SCREEN_C_ID, CViewEnums::E_SCREEN_C_EVT_BACK, &SCREEN_C_EXIT, E_SCREEN_ID::E_SCREEN_ANY_ID},
    ...
    {E_POPUP_ID::E_POPUP_X_ID, CViewEnums::E_POPUP_X_EVT_BACK, &POPUP_X_EXIT, E_POPUP_ID::E_POPUP_ANY_ID},
    ...
    {E_POPUP_ID::E_POPUP_Y_ID, CViewEnums::E_POPUP_Y_EVT_BACK, &POPUP_Y_EXIT, E_POPUP_ID::E_POPUP_ANY_ID},
    ...
    {E_POPUP_ID::E_POPUP_Z_ID, CViewEnums::E_POPUP_Z_EVT_BACK, &POPUP_Z_EXIT, E_POPUP_ID::E_POPUP_ANY_ID},
    {E_POPUP_ID::E_POPUP_Z_ID, CViewEnums::E_POPUP_Z_EVT_NAV_SCREEN_C, &SCREEN_C_ENTRY, E_SCREEN_ID::E_SCREEN_C_ID},
