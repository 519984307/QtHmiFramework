...
// [popups]
DECLARE_POPUP_INFO(POPUP_X, HmiNgin::E_DURATION::IN_2_SECS)
DECLARE_POPUP_INFO(POPUP_Y, HmiNgin::E_DURATION::IN_2_SECS)
DECLARE_POPUP_INFO(POPUP_Z, HmiNgin::E_DURATION::IN_2_SECS)

// [toast]
DECLARE_TOAST_INFO(TOAST_SUCCESS, HmiNgin::E_DURATION::IN_2_SECS)
DECLARE_TOAST_INFO(TOAST_FAIL, HmiNgin::E_DURATION::IN_2_SECS)

// [notify]
DECLARE_NOTIFY_INFO(NOTIFY_INFO, HmiNgin::E_DURATION::IN_5_SECS)
DECLARE_NOTIFY_INFO(NOTIFY_WARN, HmiNgin::E_DURATION::IN_10_SECS)
DECLARE_NOTIFY_INFO(NOTIFY_ERROR, HmiNgin::E_DURATION::IN_2_SECS)


static const HmiNgin::S_VIEW_INFORMATION ALL_INFOR[] = {
...
static const HmiNgin::S_VIEW_EVENT  ALL_EVENTS[] = {
    // [screen A]
